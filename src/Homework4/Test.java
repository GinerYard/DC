...
public class Test {
    public static void main(String[] args) {
        ...
        l3.add(t1);
        l3.add(t3);
        Course CS109_1 = new Course("Max", "Computer_programming", "CS109", 1, l1, 1);
//the capacity is only one for demostration.
        Course CS109_2 = new Course("Turing", "Computer_programming", "CS109", 2, l1, 100);
