...
public class MainGameAI {
    ...
    public static void maingameAI(int[][] board, int[][] state, int[][] pub, ArrayList<int[][]> BL, ArrayList<int[][]> SL, Var mode, int round,int c,Var clock) {
