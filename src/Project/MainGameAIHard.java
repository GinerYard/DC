...
public class MainGameAIHard {

    public static void maingameAIHard(int[][] board, int[][] state, int[][] pub, ArrayList<int[][]> BL, ArrayList<int[][]> SL, Var mode, int round,int c,Var clock) {
        ...
        if (round % 2 == 1 && clock.getClock() != -1) {
            User.plusWinningRate(clock);
        }
        if (round % 2 == 0 && clock.getClock() != -1) {
            User.minusWinningRate(clock);
        }
    }
}
