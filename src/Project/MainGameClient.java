...
public class MainGameClient {
    ...
    public static void methodClient(int x, int y, int[][] board, int[][] state, ArrayList<int[][]> BL, ArrayList<int[][]> SL) throws IOException {
        System.out.println("testtesttest");
        if (DarkChess.round % 2 == 0) {
            return;
        }
        if (Var.d == 1) {
            if (DarkChess.round == 1) {
        ...
        if (Var.d == 1) {
            ...
            Client.outDataFromClient(board, state);
        }
    ...
    public static void methodServer(int x, int y, int[][] board, int[][] state, ArrayList<int[][]> BL, ArrayList<int[][]> SL) throws IOException {
        if (DarkChess.round % 2 == 1) {
            return;
        }
        if (Var.d == 1) {
        ...
        if (Var.d == 1) {
            ...
            Server.outDataFromServer(board, state);
